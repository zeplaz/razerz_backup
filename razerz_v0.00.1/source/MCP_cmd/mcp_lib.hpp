...
class singleton_exd
{
  ...
  public :
  int cmd_unit_ID;
  singleton_exd(const Singleton&) = delete;
  singleton_exd(Singleton&&) = delete;
  singleton_exd& operator=(const Singleton&) = delete;
  singleton_exd& operator=(Singleton&&) = delete;
